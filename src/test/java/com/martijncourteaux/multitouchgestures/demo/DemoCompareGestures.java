...
/**
 * compare apple eawt and {@link com.martijncourteaux.multitouchgestures.MultiTouchGestureUtilities}
 *
 * @author martijn
 */
    ...
    public static void main(String[] args) {
        ...
        final JComponent compMT = new JComponent() {
            ...
            protected void paintComponent(Graphics gg) {
                ...
                Line2D.Double line = new Line2D.Double(getWidth() * 0.5 + x, getHeight() * 0.5 + y,
                    getWidth() * 0.5 + Math.cos(a) * l + x,
                    getHeight() * 0.5 + Math.sin(a) * l + y);
        ...
        final JComponent compApple = new JComponent() {
            ...
            protected void paintComponent(Graphics gg) {
                ...
                Line2D.Double line = new Line2D.Double(getWidth() * 0.5 + ax,
                    getHeight() * 0.5 + ay, getWidth() * 0.5 + Math.cos(aa) * al + ax,
                    getHeight() * 0.5 + Math.sin(aa) * al + ay);
                g.setColor(Color.red);
                g.setStroke(new BasicStroke(5.0f));
                g.draw(line);
            }
        ...
        MultiTouchGestureUtilities.addGestureListener(compMT, new GestureListener() {
            @Override
        ...
        compApple.addMouseWheelListener(e -> {
            if (e.isShiftDown()) {
